        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4" onClick={onClose}>
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl max-h-[90vh] flex flex-col" onClick={e => e.stopPropagation()}>
                ...
                <div className="p-6 border-t border-brand-gray-200 flex justify-end gap-3 sticky bottom-0 bg-white">
                    ...
                    <button type="submit" onClick={handleSubmit} className="bg-brand-gray-900 text-white font-semibold py-2 px-4 rounded-lg shadow-sm hover:bg-brand-gray-800 transition-colors">Salvar Membro</button>
                </div>
            </div>
            <style>{`
                .input-field {
