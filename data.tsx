...
export const appData: AppData = {
    dashboard: {
        stats: [
            { label: 'Total de Membros', value: '1', icon: <UsersIcon className="w-6 h-6 text-white" />, color: 'bg-blue-500' },
    ...
    membersPage: {
        stats: [
            { label: 'Membros Ativos', value: '1', icon: <UsersIcon className="w-6 h-6"/>, iconBgColor: 'bg-blue-100', iconTextColor: 'text-blue-600' },
        ...
        members: [
            { id: 1, name: 'Administrador', initials: 'AD', avatarColor: 'bg-purple-500', role: 'Líder', email: 'admin@sistema.com', password: 'admin123', phone: '(00) 00000-0000', joinDate: 'Jul 2024', eventsAttended: 0, studiesCompleted: 0 },
        ]
    },
    resources: [],
    finances: {
        stats: [
            ...
            { label: 'Meta de Arrecadação', value: 'R$ 0,00', icon: <CreditCardIcon className="w-5 h-5 text-brand-gray-600" />, progress: 0, change: '0% atingido' },
        ],
        incomeVsExpense: [],
        incomeByCategory: [],
        expenseByCategory: [],
    ...
    permissionsPage: {
        ...
        individualPermissionMembers: [
            { id: 1, name: 'Administrador', initials: 'AD', role: 'Líder', avatarColor: 'bg-purple-500', extraPermissions: [] },
        ],
        currentUser: {
            role: 'Líder',
